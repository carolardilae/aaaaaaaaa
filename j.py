...
class CuboBase:
    ...
    def update_objects(self):
        ...
        # Tomamos las coordenadas X e Y del sexto vértice del cubo (cara derecha)
        circle_x1, circle_y1 = projected_vertices[5]
        
        # Ajustamos las coordenadas X e Y del primer círculo para que esté en la esquina inferior derecha de la cara derecha del cubo
        ...
        self.draw_circle(circle_x1, circle_y1)
        
        # Tomamos las coordenadas X e Y del séptimo vértice del cubo (cara derecha)
        circle_x2, circle_y2 = projected_vertices[7]
        
        # Ajustamos las coordenadas X e Y del segundo círculo para que esté en la esquina superior derecha de la cara derecha del cubo
        ...
        self.draw_circle(circle_x2, circle_y2, color='blue')
        
        # Tomamos las coordenadas X e Y del cuarto vértice del cubo (cara derecha)
        circle_x3, circle_y3 = projected_vertices[3]
        
        # Ajustamos las coordenadas X e Y del tercer círculo para que esté en la esquina superior izquierda de la cara derecha del cubo
        ...
        self.draw_circle(circle_x3, circle_y3, color='orange')
